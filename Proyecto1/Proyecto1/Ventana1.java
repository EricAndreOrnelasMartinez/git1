...
public class Ventana1 extends JFrame{
    ...
    Ventana1 ob;
    JLabel ghost1, ghost2, ghost3, ghost4, ghost5, ghost6;  
    ...
    public Ventana1() {
        ...
        panel.add(p46);
        salida = new JLabel(); 
        salida.setBounds(40, 0, 60, 20);
        salida.setOpaque(true);
        salida.setVisible(false); 
        salida.setBackground(Color.BLUE);
        panel.add(salida); 
        timer = new Timer(); timer2 = new Timer(); timer3 = new Timer();
        ...
        KeyListener key = new KeyListener(){
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if(target1.getX() < 621 && canmoveright()){
                    ...
                    target1.setLocation(x, target1.getY());
                    target1.setIcon(new ImageIcon(getImage().getImage().getScaledInstance(target1.getWidth(), target2.getHeight(), Image.SCALE_SMOOTH)));
                    }
                }
    ...
    public boolean touchG(JLabel comp){
        boolean flag = false;
        if(comp.getY() <= target1.getY() + 50 && comp.getY() >= target1.getY() - 50   ){
            if(target1.getX() + 50 >= comp.getX() && target1.getX() - 50 <= comp.getX()){
                flag = true;
            }
    ...
    public ImageIcon getImage(){
        ImageIcon imagen = new ImageIcon("pacmandba.jpg");
        return imagen; 
    }
}